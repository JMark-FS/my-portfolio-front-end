...
export default function AboutPageContent() {
  const skills = [
    ...
    'Python', 'HTML', 'CSS', 'MongoDB', 'PostgreSQL',
    'Git', 'AWS', 'Docker', 'Material-UI'
  ];
  ...
  const experiences = [
    ...
    },
    {
      ...
      duration: "2022 - 2023",
      description: "Focused on creating responsive and user-friendly interfaces using React and modern CSS frameworks. Implemented best practices for performance optimization and accessibility."
    }
  ];
  ...
  const education = [
    {
      ...
      duration: "2018 - 2022", 
      description: "Graduated with honors. Specialized in software engineering and web development. Participated in various coding competitions and hackathons."
    }
  ];
